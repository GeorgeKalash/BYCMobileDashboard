      ...
      <div className="form-group m-0 w-100">
        <div className="Typeahead Typeahead--twitterUsers">
          <div className="u-posRelative d-flex align-items-center">
            ...
            <input className="demo-input py-0 Typeahead-input form-control-plaintext w-100 border-0" type="text" placeholder={Search} name="q" title="" onChange={(e) => handleSearch(e)} value={searchedWord}/>
          </div>
