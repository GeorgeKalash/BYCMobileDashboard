...
const validationSchema = Yup.object({
  ...
  yakeen_daily_request_count: Yup.number().min(0, "Must be at least 0"),
  yakeen_monthly_request_count: Yup.number().min(0, "Must be at least 0"),
  yakeen_user_daily_request: Yup.number().min(0, "Must be at least 0"),
  daily_user_new_request: Yup.number().min(0, "Must be at least 0"),
});
